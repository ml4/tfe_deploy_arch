...
#
output "tvs-tvs-dynamic_creds-id" {
  value       = tfe_variable_set.dynamic_creds.id
  description = "TFE Variable Set id"
}

output "air-air-role-arn" {
  value       = aws_iam_role.hcpt_role.arn
  description = "OIDC Role ARN created"
}
